...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    // ***Source: https://www.horadecodar.com.br/2021/04/01/quantidade-de-elementos-de-um-objeto-em-javascript/
    // ***Source: https://jestjs.io/pt-BR/docs/expect#tohavelengthnumber
    ...
    expect(Object.values(circle(3))[0]).toBe(3);//radius
    expect(Object.values(circle(3))[1]).toBe(28.259999999999998);//area
    expect(Object.values(circle(3))[2]).toBe(18.84);//circumference    
  });
});
