...
const calculator = (number1, number2) => {
  ...
  const dividir = Math.floor(number1 / number2);
  return { sum: somar, mult: multiplicar, div: dividir, sub: subtrair };
};
 
// console.log(calculator(5, 2));

// Consultei material no Slack para entender essa parte do projeto.
// Source: https://trybecourse.slack.com/archives/C02HY0NGPK4/p1641317762295300 
